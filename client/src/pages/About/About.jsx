        ...
        <div className="block">
            <div className="container">
                ...
                <div className="about__block" id="licenses">
                    {
                        licenses.length !== 0
                            ? <h5 className="about__block-title">Лицензии</h5>
                            : <div></div>
                    }
                    <Licenses />
                </div>
                    ...
                    <div className="contact__contacts">
                        <YMaps>
                            <Map defaultState={mapData} className="map">
                                {coordinates.map(coordinate => <Placemark key={1} geometry={coordinate} />)}
                            </Map>
                        </YMaps>
                        ...
                        <div className="contact__item">
                            <div className="contact__content">
                                ...
                                <div className="contact__info">
                                    <a className="contact__item__link" href="">г. Омск, ул. Герцена, д.38</a>
                                    <a className="contact__item__link" href="">Телефон: 499-678</a>
                                    <a className="contact__item__link" href="">E-mail: profimed55@yandex.ru</a>
                                </div>
                            </div>
                        </div>
                    </div>
