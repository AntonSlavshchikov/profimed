...
export const WorkersItem = (props) => {
    ...
    return (
        <div className="workers__item">
            ...
            <img src={process.env.REACT_APP_API_URL + props.workers.image} alt="" className="workers__img" />

            <a className="workers__link-mobile" onClick={() => navigate(`/workers/${props.workers.id}`)}>Узнать подробнее о враче</a>
